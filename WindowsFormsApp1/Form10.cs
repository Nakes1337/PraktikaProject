        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (listBox1.SelectedIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    Col = заказчикDataGridViewTextBoxColumn;
                    break;
                case 2:
                    Col = откудаDataGridViewTextBoxColumn;
                    break;
                case 3:
                    Col = кудаDataGridViewTextBoxColumn;
                    break;
                case 4:
                    Col = датаОтправленияDataGridViewTextBoxColumn;
                    break;
                case 5:
                    Col = датаПрибытияDataGridViewTextBoxColumn;
                    break;
                case 6:
                    Col = кодГрузаDataGridViewTextBoxColumn;
                    break;
                case 7:
                    Col = ценаDataGridViewTextBoxColumn;
                    break;
                case 8:
                    Col = отметкаОбОплатеDataGridViewTextBoxColumn;
                    break;
                case 9:
                    Col = отметкаОВозвращенииDataGridViewTextBoxColumn;
                    break;
                case 10:
